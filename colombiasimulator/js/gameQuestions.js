    ...
    [
        ...
        },
        {
            ...
            options: [
                ...
                { option: "Avoid the question and claim that nothing of the sort has happened", left: -10, right: -10, result: "Your evasiveness damages your reputation and erodes public trust, making it seem like you are protecting the corrupt." },
                { option: "Promise that your administration will do everything to prevent corruption", left: -5, right: -5, result: "People are skeptical of your promises without seeing immediate and concrete actions, fearing that this may just be another empty assurance." }
            ]
        },
        {
            ...
            options: [
                { option: "Promise to dissolve the current insurance providers and nationalize the system", left: 10, right: -10, socioeconomic: 10, result: "You are praised for ensuring healthcare for all, but face criticism for potential inefficiencies and the high cost of nationalizing the system." },
                { option: "Allow the company to withdraw and become a private healthcare provider", left: -10, right: 10, socioeconomic: -10, result: "Your decision supports free market principles, potentially increasing efficiency and innovation, but could reduce access to healthcare for the poor." },
                { option: "Force the company to remain within the public system and promise more funding in the future", left: -5, right: -5, result: "You are seen as taking a balanced approach, but both sides have reservations about your long-term commitment and the practicality of your promise." }
            ]
        },
        {
            ...
            options: [
                { option: "Privatize parts of the education system", left: -10, right: 10, socioeconomic: -10, result: "Your move to privatize education is seen as a way to increase efficiency and innovation, but faces backlash for potentially increasing inequality." },
                { option: "Maintain current education funding levels", left: -5, right: -5, result: "People are disappointed by your lack of action to address the pressing issue of illiteracy, seeing it as a missed opportunity to improve education." },
                { option: "Increase funding for public education", left: 10, right: -10, socioeconomic: 10, result: "Your commitment to public education is applauded, but some worry about the financial burden and potential inefficiencies in the system." },
            ]
        },
        {
            ...
            options: [
                { option: "Argue that your government will take this as an opportunity to reverse the abortion law to protect unborn babies", left: -10, right: 10, cultural: -10, result: "You gain support from pro-life advocates, bolstering your stance on traditional values, but face strong opposition from women's rights groups." },
                { option: "Argue that the law can indeed be interpreted in different ways but is not in need of revision", left: -5, right: -5, result: "Your neutral stance is seen as avoiding the issue, leading to dissatisfaction from both sides who want clear and decisive action." },
                { option: "Argue that your government will take this as an opportunity to strengthen the abortion law to protect the rights of women", left: 10, right: -10, cultural: 10, result: "Your stance on women's rights is praised by progressives, but conservative groups strongly oppose any move to expand abortion rights." },
            ]
        },
        {
            ...
            options: [
                { option: "Do nothing, stating that land was legally acquired by the landowners and you are no communist", left: -10, right: 10, socioeconomic: -10, result: "Your stance on property rights is appreciated by some, but you face backlash for ignoring the pressing needs of rural communities and perpetuating inequality." },
                { option: "Argue land is no longer important in a modern economy and promote investments in Bitcoin", left: -10, right: -10, result: "Your response is widely criticized as out of touch with the realities of rural communities, who need tangible solutions rather than speculative investments." },
                { option: "Force big landowners to sell their land and redistribute it to rural communities", left: 10, right: -10, socioeconomic: 10, result: "You are praised for addressing inequality and supporting rural communities, but face strong opposition from wealthy landowners and potential legal challenges." }
            ]
        },
        {
            ...
            options: [
                { option: "Argue that your country cannot reduce oil exports due to economic impacts", left: -10, right: 10, political: -10, result: "You are seen as protecting the economy and ensuring continued growth, but are criticized for not addressing the urgent issue of climate change." },
                { option: "Indicate that your country may reduce oil production in the future", left: -5, right: -5, result: "Your vague stance leaves both environmentalists and the oil industry uncertain about your plans, leading to mixed reactions." },
                { option: "Promise that your country will immediately halt new oil exploration", left: 10, right: -10, political: 10, result: "You are praised for taking bold action on climate change, showing strong environmental leadership, but face strong opposition from the oil industry and concerns about economic impacts." }
            ]
        },
        {
            ...
            options: [
                { option: "Increase military presence in conflict zones", left: -10, right: 10, political: -10, result: "Your strong response to violence is praised by some, but raises concerns about potential human rights abuses and escalating conflicts." },
                { option: "Call for increased peace talks with armed groups", left: 10, right: -10, political: 10, result: "Your commitment to peace and dialogue is appreciated by progressives and human rights advocates, but some see it as a sign of weakness and appeasement." },
                { option: "Promise to do better next year", left: -5, right: -5, result: "Your lack of concrete action is seen as insufficient to address the urgent crisis, leading to dissatisfaction and frustration from all sides." }
            ]
        },
        {
            ...
            options: [
                { option: "Implement strict price controls on essential goods", left: 20, right: -20, socioeconomic: 20, result: "You are praised for trying to protect the most vulnerable, but businesses warn that price controls could lead to shortages and worsen the crisis." },
                { option: "Cut government spending to reduce inflation", left: -20, right: 20, socioeconomic: -20, result: "You are commended for fiscal responsibility, but critics argue that cuts to social programs will hurt the poor and vulnerable." },
                { option: "Negotiate with international lenders for economic support", left: -10, right: -10, result: "Your diplomatic efforts are seen as a balanced approach, but people want immediate relief from the economic hardships they face." }
            ]
        },
        {
            ...
            options: [
                { option: "Create a government-funded job program", left: 20, right: -20, socioeconomic: 20, result: "You are praised for directly addressing unemployment, but concerns are raised about the long-term sustainability and cost of the program." },
                { option: "Provide tax incentives for businesses to hire more workers", left: -20, right: 20, socioeconomic: -20, result: "Your pro-business approach is appreciated for potentially boosting employment, but critics argue it might not help those most in need." },
                { option: "Increase support for vocational training and education", left: -10, right: -10, result: "Your focus on long-term solutions through education is welcomed, but immediate relief is still needed." }
            ]
        },
        {
            ...
            options: [
                { option: "Meet with protest leaders and negotiate their demands", left: 20, right: -20, political: 20, result: "Your willingness to engage in dialogue is praised, but some see it as a sign of weakness." },
                { option: "Deploy police to disperse the protests", left: -20, right: 20, political: -20, result: "Your strong stance on maintaining order is appreciated by some, but criticized for potentially escalating tensions and infringing on civil rights." },
        ...
        },
        {
            ...
            options: [
                { option: "Increase funding for refugee camps and support services", left: 20, right: -20, cultural: 20, socioeconomic: 20, result: "You are praised for your humanitarian response, but concerns about the economic impact on Colombia are raised." },
                { option: "Strengthen border controls to limit the number of migrants", left: -20, right: 20, cultural: -20, socioeconomic: -20, result: "Your focus on protecting national resources is appreciated by some, but criticized for lacking compassion and ignoring human rights." },
                { option: "Work with international organizations for a coordinated response", left: -10, right: -10, result: "Your diplomatic approach is seen as a sensible way to share the burden, but immediate needs remain pressing." }
            ]
        },
        {
            ...
            options: [
                { option: "Arrest the militia leaders and promise to reinforce law enforcement", left: 20, right: -20, political: 20, result: "You are praised for upholding the rule of law, but face backlash from those who see the militia as necessary protection." },
                { option: "Integrate the militia into a community policing program", left: -20, right: 20, political: -20, result: "Your attempt to co-opt the militia is seen as a pragmatic move, but critics argue it legitimizes and empowers dangerous groups." },
                { option: "Create special refugee camps to protect the Venezuelans", left: 20, right: -20, political: 20, result: "Your approach is seen as cautious, but many worry it could allow the militia to grow unchecked." }
            ]
        },
        {
            ...
            options: [
                { option: "Increase military salaries and improve conditions", left: -20, right: 20, political: -20, result: "You are praised for supporting the military, but face criticism for diverting funds from other critical areas." },
                { option: "Replace dissenting leaders and reinforce loyalty to your administration", left: -20, right: 20, political: -20, result: "Your decisive action strengthens your control, but raises concerns about potential purges and instability." },
                { option: "Open a dialogue with military leaders to address their concerns", left: 20, right: -20, political: 20, result: "Your approach to dialogue is seen as wise, but some view it as a sign of weakness." }
            ]
        },
        {
            scenario: "RISE RADICAL LEFT\nDuring a meeting with your cabinet, you receive worrying news. The Minister of Labor informs you that the unemployment rate is expected to increase to 30%. The Minister of Health shows you a report indicating that 200,000 Colombians have died this year from hunger-related diseases. The Minister of the Interior warns you that people are losing faith in the government and are flocking to the new radical Colombian Proletarian Party. There are rumors that the leadership of the party is planning a violent revolt against the government. How do you respond?",
            options: [
                { option: "Launch a public works program to provide immediate employment and food aid to the poor", left: 20, right: -20, socioeconomic: 20, result: "Your swift action to provide jobs and food aid is praised for addressing the immediate needs of the population. However, critics warn that this approach may strain the national budget and not address the root causes of the crisis." },
                { option: "Increase security measures and crack down on the leadership of the Colombian Proletarian Party", left: -20, right: 20, political: -20, result: "Your decision to increase security and crack down on potential threats is seen as necessary by those seeking stability. However, it raises concerns about human rights and the potential for escalating violence." },
                { option: "Initiate negotiations with the Colombian Proletarian Party to address their concerns and seek a peaceful resolution", left: 20, right: -20, political: 20, result: "Your willingness to engage in dialogue is praised for seeking a peaceful solution. However, some view it as a sign of weakness and fear it might embolden other radical groups." }
            ]
        },
        {
            ...
            options: [
                { option: "Impose martial law and send more military forces to regain control.", left: -20, right: 20, politics: -20, result: "Your strong action to impose martial law and send more military forces is seen as needed to restore order. However, it raises concerns about civil rights and the potential for more violence."},
                { option: "Address the nation, call for calm, and promise quick action to fix the issues.", left: -10, right: -10, result: "Your call for calm and promise to address the issues is praised for trying to ease the tension. However, many think it is not enough without immediate action to restore security."},
                { option: "Start immediate talks with the leaders of the Colombian Proletarian Party to seek a ceasefire.", left: 20, right: -20, politics: 20, result: "Your willingness to negotiate is seen as a brave move for peace. However, it is also viewed as giving in to violence and could weaken your authority."}
            ]
        },
        {
            ...
            options: [
                { option: "Pledge full military support to the USA", left: -20, right: 20, political: -20, result: "Your strong alliance with the USA is praised for strengthening international ties and demonstrating Colombia's commitment to global security. However, critics argue that this decision could drag Colombia into a dangerous and costly conflict." },
                { option: "Offer diplomatic support but avoid military involvement", left: -10, right: -10, result: "Your balanced stance of offering diplomatic support without military involvement is seen as pragmatic and cautious. However, some feel it lacks the commitment expected by an ally." },
                { option: "Refuse to support the USA in the conflict", left: 20, right: -20, political: 20, result: "Your decision to prioritize neutrality is praised by those who want to keep Colombia out of foreign wars. However, it is seen as abandoning an important ally and could damage relations with the USA." }
            ]
        },
        {
